...
public class GameLayoutAdapter extends RecyclerView.Adapter<GameLayoutAdapter.SimpleViewHolder> {
    ...
    private List<Adverts> indexadverts;
...
//            title = (TextView) view.findViewById(id.title);
    ...
    public GameLayoutAdapter(Context context, RecyclerView recyclerView) {
    }

    public GameLayoutAdapter(Context context, RecyclerView recyclerView, List<Adverts> indexAdvertList) {
        mContext = context;
