package com.wheel.pickaddress.wheel.widget.adapters;
 ...
 */
public abstract class AbstractWheelNameValAdapter extends AbstractWheelAdapter {
     ...
     *            the current context
     */
    protected AbstractWheelNameValAdapter(Context context) {
     ...
     */
    protected AbstractWheelNameValAdapter(Context context, int itemResource) {
     ...
     */
    protected AbstractWheelNameValAdapter(Context context, int itemResource, int itemTextResource, int currentIndex,
...
//    protected abstract CharSequence getItemText(int index);
    protected abstract NameVal getItemdata(int index);
    ...
    public View getItem(int index, View convertView, ViewGroup parent) {
        if (index >= 0 && index < getItemsCount()) {
            ...
            if (textView != null) {
                NameVal text = getItemdata(index);
                if (text == null) {
                    text =new NameVal();
                    text.setVal("");
                    text.setId("");
                }
                textView.setText(text.getVal());
